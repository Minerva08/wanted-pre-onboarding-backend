...
public enum EnumResponseMessage {
	...
	MESSAGE_ER_AL_JOB_POSITION     (3001, "USR-ER-AL-J-POSITION",  "해당 직무의 채용 공고가 이미 등록 되어있습니다"),
	MESSAGE_ER_APPLY    		(4000, "USR-ER-APPLY",  "해당 공고에 지원할 수 없습니다"),
	MESSAGE_NO_APPLY    		(4001, "USR-NO-APPLY",  "지원 내역이 없습니다"),
	MESSAGE_ER_C_ROLE    		(5000, "USR-ER-C-ROLE", "해당 회사에 등록 되지 않은 직무 입니다"),
	MESSAGE_ER_ROLE    			(6000, "USR-ER-C-ROLE", "해당 역할을 등록할 수 없습니다"),
	;
